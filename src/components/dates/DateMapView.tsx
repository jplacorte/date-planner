    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="relative w-full h-[440px] sm:h-[560px] rounded-2xl sm:rounded-3xl overflow-hidden border border-white/[0.08] bg-black shadow-2xl flex flex-col justify-between">
        ...
        <svg className="absolute inset-0 w-full h-full opacity-20 pointer-events-none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M 140,460 Q 420,320 840,460 T 1180,410" fill="none" stroke="#52525b" strokeWidth="1.5" strokeDasharray="5,5" />
        </svg>
              ...
              >
                ...
                <div
                  className={`relative flex items-center gap-1.5 px-2 sm:px-2.5 py-1 rounded-xl border backdrop-blur-md transition-all shadow-md ${
                    isSelected
                      ? 'bg-white text-zinc-950 border-white scale-110 shadow-lg'
                ...
                <div className="flex-1 space-y-1 sm:space-y-1.5 min-w-0">
                  ...
                  <div className="flex items-center gap-2 pt-1">
                    <button
                      ...
                      className="flex items-center gap-1 px-2.5 sm:px-3 py-1 sm:py-1.5 rounded-full bg-white hover:bg-zinc-200 text-zinc-950 text-[11px] sm:text-xs font-semibold shadow-sm transition-colors"
                    >
                      <span>Checklist</span>
