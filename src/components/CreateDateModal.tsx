    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="relative w-full max-w-2xl rounded-3xl overflow-hidden bg-zinc-950 border border-white/[0.1] shadow-2xl p-6 sm:p-7 space-y-5 max-h-[88vh] overflow-y-auto overscroll-contain my-auto"
          data-lenis-prevent
        >
          {/* Header */}
